...
from streamlit_app.state import (
    get_display_state,
    is_in_playback_mode,
    init_session_state, reset_episode, step_agent, run_batch_training, # 1D
    init_session_state_2d, reset_episode_2d, step_agent_2d, run_batch_training_2d, # 2D
)
...
with tab_1d:
    ...
    with col_info:
        ...
        with st.expander("📊 Steps per Episode", expanded=True):
            render_steps_chart(display_state_1d["steps_per_episode"], display_state_1d["q_history_plot"])
...
with tab_2d:
    ...
    with col_info_2d:
        ...
        with st.expander("📊 Steps per Episode", expanded=True):
            render_steps_chart(display_state_2d["steps_per_episode"], display_state_2d["q_history_plot"])
